...
const SMALL_IOTA: &[&str] = &[
    "\u{03b9}", "\u{1f76}", "\u{03af}", "\u{1fd6}", "\u{1f30}", "\u{1f32}", "\u{1f34}", "\u{1f36}",
    "\u{1f31}", "\u{1f33}", "\u{1f35}", "\u{1f37}", "\u{03ca}", "\u{1fd2}", "\u{0390}", "\u{1fd7}",
    "\u{03ca}", "\u{1fd2}", "\u{0390}", "\u{1fd7}", "\u{03ca}", "\u{1fd2}", "\u{0390}", "\u{1fd7}",
];
...
const SMALL_YPSILON: &[&str] = &[
    "\u{03c5}", "\u{1f7a}", "\u{03cd}", "\u{1fe6}", "\u{1f50}", "\u{1f52}", "\u{1f54}", "\u{1f56}",
    "\u{1f51}", "\u{1f53}", "\u{1f55}", "\u{1f57}", "\u{03cb}", "\u{1fe2}", "\u{03b0}", "\u{1fe7}",
    "\u{03cb}", "\u{1fe2}", "\u{03b0}", "\u{1fe7}", "\u{03cb}", "\u{1fe2}", "\u{03b0}", "\u{1fe7}",
];
